...
public class JDBC_Query01 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        // 2. ADIM: Veritabani ile iletisimi baslat(Connection hazirlama)
        ...
        // Ancak bir bu create edilen connection`i bir objeye atama yapmazsak daha sonra ihtiyac halinde ona erisemeyiz.
        // En saglikli olan Connection connection = DriverManager.getConnection() seklinde yazilmasidir.

        // 3. ADIM: SQL sorgulari yonetebilmek icin bir suite hazirla(Suit hazirlama)
        Statement statement = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);

        // Bir statement olusturabilmek icin MUTLAKA bir connection`imiz olmak zorunda.
        // Statement olusturulurken connection.createStatement(); connection uzerinden bu yapi create edilir.
        // connection.createStatement(); icerisine ResultSet Type ve ResultSet Concurrency bilgileri girilir/
        // bu ayarlar cok spesifik bir suit olusturmuyor ise genelde degismez ve her yerde kullanilan ayarlardir.
        ...
        // Ayrıca bu statement ile elde edilen sonuçların scroll edilebilir ve read only olmasını istedik.
        ...
        // Database baglantilari acilip sorgu gercekletirildikten hemen sonra mutlaka kapatilmalidir.
        // Database baglantisi kurulurken gerceklestirilen sira (connection > statement > resultSet)
        // Database baglantisi kapatilirken tersten isleme tabi tutulur (resultSet > statement > connection)
